...
{
    public sealed partial class UpdateLandEndpoint : IMinimalEndpoint
    {
        ...
        {
            var updateResult = await dispatcher.ExecuteAsync(new UpdateLandOperation.Request(id, request), cancellationToken);
