...
public sealed partial class GetClientsOperation
{
    public sealed record Request(GetAllClientsEndpoint.Request Payload) : IOperationRequest<PagedList<Response>>;
}
