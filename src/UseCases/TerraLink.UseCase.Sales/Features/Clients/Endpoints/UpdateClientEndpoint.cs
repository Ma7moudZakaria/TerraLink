...
{
    public sealed partial class UpdateClientEndpoint : IMinimalEndpoint
    {
        ...
        {
            var updateResult = await dispatcher.ExecuteAsync(new UpdateClientOperation.Request(id, request), cancellationToken);
