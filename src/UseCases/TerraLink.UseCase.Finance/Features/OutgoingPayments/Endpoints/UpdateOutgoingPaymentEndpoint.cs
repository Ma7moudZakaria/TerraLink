...
public sealed partial class UpdateOutgoingPaymentEndpoint : IMinimalEndpoint
{
    public static void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapPut("/{id:guid}", Handle)
           ...
           .WithSummary("Update outgoing payment")
    ...
    {
        var command = new UpdateOutgoingPaymentOperation.Request(
            id,
