...
public sealed partial class CreateIncomingPaymentEndpoint : IMinimalEndpoint
{
    public static void AddRoute(IEndpointRouteBuilder app)
    {
        app.MapPost("/", Handle)
           ...
           .AddLogging()
           .WithName("CreateIncomingPayment")
           .WithSummary("Create incoming payment")
    ...
    {
        CreateIncomingPaymentOperation.Request command = ObjectMapper.Map<Request, CreateIncomingPaymentOperation.Request>(request);
